...
Sub EventLoop()
    ...
    while true
        ...
        if msg <> invalid             
            ...
            print "Msg Type: "; msg.GetType(); " Msg Index: "; msg.GetIndex(); " Message: "; msg.GetMessage()            
...
Sub PaintFullscreenCanvas()
    print "In PaintFullscreenCanvas"
    list = []
    ...
    else if m.progress < 100 and m.progress >= 0
        print "m.progress < 100 and m.progress >= 0"
        color = "#000000" 'opaque black
        list.Push({
